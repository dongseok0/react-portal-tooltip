...
var Card = (function (_React$Component) {
  ...
  _createClass(Card, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var pW = prevState.width;
      var pH = prevState.height;
      var pP = prevState.position;

      if (w !== pW || h !== pH || p !== pP || this.props !== prevProps) {
        this.setState(_extends({}, this.checkWindowPosition(this.style, this.arrowStyle)));
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var _state2$style = _state2.style;
      var style = _state2$style === undefined ? this.style : _state2$style;
      var _state2$arrowStyle = _state2.arrowStyle;
      var arrowStyle = _state2$arrowStyle === undefined ? this.arrowStyle : _state2$arrowStyle;
    ...
    get: function get() {
      ...
      (0, _objectAssign2['default'])(style, this.getStyle(this.state.position, this.props.arrow));
